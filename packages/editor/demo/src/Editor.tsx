...
import { TypeJsonEditor, TypeJsonEditorFileAPI } from '../../src';
...
declare const ts: typeof typescript | undefined;
...
function Editor() {
  ...
  // useScript('https://cdn.jsdelivr.net/npm/typescript@5.6.2/lib/typescript.min.js', {
  //   id: 'typescript',
  //   removeOnUnmount: false,
  // });

  if (!monaco) return 'Monaco loading...';
  // if (!ts) return 'Typescript loading...';
